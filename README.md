...
1. โหลดไฟล์ [`run.bat`](./run.bat) ไฟล์เดียว (ไม่ต้อง clone ทั้ง repo) มาเก็บไว้โฟลเดอร์ไหนก็ได้ในเครื่อง (เช่น Desktop)
...
3. เสร็จแล้ว! ทุกครั้งที่ดับเบิลคลิก `run.bat` จะได้เวอร์ชันล่าสุดจาก GitHub เสมอโดยอัตโนมัติ ไม่ต้องอัปเดตเอง
